...
const Login = withRouter(connect(mapStateToProps, mapDispatchToProps)(function Login(props) {
    const { user, setUserName, setUserPass, login, handleSubmit, reset, pristine, submitting, valid, history } = props
    ...
    return (
        <>
            <from onSubmit={handleSubmit((values) => { })}>
                <div className="container-fluid" class="form-info-section">
